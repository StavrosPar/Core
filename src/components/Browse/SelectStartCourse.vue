<template >
 <v-content style="padding: 0px 0px 0px;"  >
      ...
      <v-snackbar  v-model="snackbar"  multi-line="multi-line"  right="right" :timeout="timeout" top="top" color="orange">
         <v-icon> warning </v-icon>  {{text}}       
    ...
    <p v-if="selected!=undefined" class="text-xs-center" id="titl" xs12 sm10 md6 lg4 >Learn how to programm in {{selected}} in a course</p>        
    ...
    <p v-if="selected!=undefined" class="text-xs-center" id="chtitl" xs12 sm10 md6 lg4 ><span style="color:#bf810d">Or</span> <br>Complete it at once</p>
...
#mbtn2:hover{
    box-shadow: 0 0 50px rgba(54, 154, 193, 0.75), 0 0 50px rgba(54, 154, 193, 0.75);
}
